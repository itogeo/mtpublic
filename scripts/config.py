...
# DIRECTORY PATHS
# =============================================================================
PROJECT_DIR = Path(__file__).parent.parent  # scripts/ is one level down from project root
...
# =============================================================================
# Buffer tolerance for adjacency detection (handles survey gaps between parcels)
ADJACENCY_BUFFER_M = 10.0  # ~33 feet

# State/DNRC ownership categories to target
STATE_OWNER_CATEGORIES = ["STATE"]
